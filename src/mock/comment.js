...
// 1. 准备一个包含 20 个元素的数组
const myArray = [
    "我入手了一批橡木的木方，用于制作一些家具，但发现有些木方的纹理不太一致，甚至有些角度有裂痕。真的很失望，这让我对这家商家的质量产生了怀疑。",
    ...
    "我买了一批柚木木皮，用于贴在家具上。然而，我发现有几张木皮的颜色和纹理与其他的完全不同，这让我觉得这家商家的产品质量实在是太糟糕了。",
    "我买了一批杉木木制线条，用于装修新房。线条表面光滑，没有凹凸不平的地方，真的很满意。",
    "从这家商家购买了一些柚木木方，木方颜色均匀，纹理清晰，为我们的家具增添了高贵的气质。",
    "我买了一些枫木胶合板，用于制作桌子。胶合板质量优秀，表面无划痕，边缘完美无瑕。我非常满意这次购买。",
    "我买了一批紫檀木皮，用于贴在家具上。木皮颜色和纹理都与其他产品相符，这让我觉得这家商家的产品质量非常好。",
    "入了一些橡木刨花木墩，用于厨房里的柜子。刨花木墩非常坚固，边缘平整，让我的厨房柜子更美观实用。",
    ...
    "我买了一些建筑模板用于工地，模板非常平整，没有弯曲变形，给我们的施工带来了很大的便利。",
