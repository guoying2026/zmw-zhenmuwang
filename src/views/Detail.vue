    ...
    <div class="top margin-20-top">
      <div class="top_2 margin-20-top">
        <div class="margin-10-top top_2_1">
          ...
          <text class="margin-10-left">我们是</text>
        </div>
        <text class="margin-10-top emphasize">费县众泽木业板材厂费县众泽木业板材厂</text>

        <text class="margin-10-top">社会统一信用代码：</text>
        <text class="margin-10-top emphasize">91120222058746278C</text>
        <text class="margin-10-top">复制我们名字或者社会统一信用代码，可以在ZMW精准搜索到我们哦</text>
<!--        <text>法定代表人：</text>-->
<!--        <text>刘海东</text>-->
<!--        <text>成立时间：</text>-->
...
<!--        <text>电子设备技术开发塑料制品、木制品、计算机外围设备制...</text>-->
  ...
  <el-container direction="vertical" :gutter="24" class="margin-20-top">
