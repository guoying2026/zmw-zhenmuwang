<template>
<div class="app-container margin-60-top">
...
<div class="app-content">
  <div class="app-sidebar">
    ...
    <a href="" class="app-sidebar-link">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="link-icon feather feather-pie-chart" viewBox="0 0 24 24">
        <defs />
    ...
    <a href="" class="app-sidebar-link">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="feather feather-settings link-icon" viewBox="0 0 24 24">
        <defs />
